          ...
          {presets.map((preset) => {
            ...
            return (
              <Link
                ...
                className="flex items-center justify-between rounded-lg px-3 py-2 hover:bg-[var(--color-surface-50)] transition-colors"
              >
                <span className="text-sm text-[var(--color-text-primary)]">{preset.name}</span>
