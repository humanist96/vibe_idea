...
export function DividendSustainabilityCard(props: Props) {
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="flex items-center gap-2 rounded-lg bg-green-500/5 border border-green-500/20 p-2.5">
            ...
            <div className="text-[11px]">
              ...
              <span className="font-medium text-[var(--color-text-primary)]">{data.projection.nextYearEstimate.toLocaleString()}원</span>
